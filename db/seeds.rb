...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490163371/ny2_btzs1q.jpg",
  city: "New York",
  host_id: 8,
  booked: false,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490163373/ny3_f4x5wx.jpg",
  city: "New York",
  host_id: 9,
  booked: false,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490163371/ny4_vh9wcj.jpg",
  city: "New York",
  host_id: 10,
  booked: false,
...
Room.create(
  ...
  avail_start: Date.new(2017, 8, 1),
  avail_end: Date.new(2017, 8, 5),
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490163353/la3_vy3j5o.jpg",
  city: "Los Angeles",
  host_id: 14,
  booked: false,
  lat: 34.1028349,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490163353/la4_qwuifg.jpg",
  city: "Los Angeles",
  host_id: 15,
  booked: false,
  lat: 34.1156181,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490163374/par2_sq49le.png",
  city: "Paris",
  host_id: 18,
  booked: false,
...
Room.create(
  ...
  avail_end: Date.new(2017, 7, 15),
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490217261/par4_a3vptv.jpg",
  city: "Paris",
  host_id: 20,
  booked: false,
  lat: 48.8772337,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490217357/rio3_tcg9d8.jpg",
  city: "Rio de Janeiro",
  host_id: 23,
  booked: false,
  lat: -22.9252191,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490217283/tok2_kvlnym.jpg",
  city: "Tokyo",
  host_id: 25,
  booked: false,
  lat: 35.6537733,
...
Room.create(
  ...
  avail_start: Date.new(2017, 7, 5),
  avail_end: Date.new(2017, 7, 22),
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490217246/joh1_jzbx77.jpg",
  city: "Johannesburg",
  host_id: 27,
  booked: false,
  lat: -26.2009599,
...
Room.create(
  ...
  avail_start: Date.new(2017, 8, 1),
  avail_end: Date.new(2017, 8, 10),
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490217246/joh2_girgpn.jpg",
  city: "Johannesburg",
  host_id: 28,
  booked: false,
  lat: -26.20414,
...
Room.create(
  ...
  image_url: "https://res.cloudinary.com/dmhxtvnmi/image/upload/v1490217273/sf6_o46igy.jpg",
  city: "San Francisco",
  host_id: 30,
  booked: false,
